...
# Uso:
#   bash comecar.sh
#   curl -fsSL https://raw.githubusercontent.com/victorromling29-ops/DeskcommCRM/main/hostgator-setup-kit/comecar.sh | bash
#
set -euo pipefail

REPO_URL="${REPO_URL:-https://github.com/victorromling29-ops/DeskcommCRM.git}"
